import { consultarEstadoCuentaArrendamientos } from "../../../api/arrendamientosService";
...
export default function ArrendamientosEstadoCuentaPage() {
  return (
    <ArrendamientosListPage
      title="Estado de cuenta"
      description="Vista resumida del saldo y movimiento por contrato."
      searchHint="codigo, contrato, concepto, periodo, estado"
      loadRows={() => consultarEstadoCuentaArrendamientos({})}
      columns={columns}
      emptyMessage="No existen registros para el estado de cuenta."
    />
  );
}
