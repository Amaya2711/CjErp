...
function mapItem(raw: Record<string, unknown>): ExternoCrudItem {
  return {
    ...
    idSexo: toNumber(raw.idSexo ?? raw.idsexo ?? raw.IdSexo),
    ...
    idUsuario: toStringValue(raw.idUsuario ?? raw.IdUsuario),
    idDocumento: toNumber(raw.idDocumento ?? raw.iddocumento ?? raw.IdDocumento),
