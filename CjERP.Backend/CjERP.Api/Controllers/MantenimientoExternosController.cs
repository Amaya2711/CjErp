...
public class MantenimientoExternosController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var parameters = BuildUpsertParameters(request, usuario, idCargo);
        ...
        int? idEmpleado = null)
    {
        ...
        parameters.Add("@IdCargo", idCargo ?? CargoId, DbType.Int32);
    ...
    private static ExternoCrudDto MapExternoCrudRow(IDictionary<string, object> values)
    {
        return new ExternoCrudDto
        {
            ...
            IdUsuario = GetString(values, "IdUsuario", "idUsuario"),
    ...
    private static int? ResolveSexoId(ExternoCrudUpsertRequest request)
    {
        ...
        if (int.TryParse(request.Sexo, out var parsed) && parsed > 0)
        {
            return parsed;
        }
